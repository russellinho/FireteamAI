        ...
        public void ModalWindowOut()
        {
            if (titleController != null) {
                if (mainPanelManager.currentPanelIndex == MainPanelManager.MOD_SHOP_INDEX) {
                    ...
                    if (PlayerData.playerdata.bodyReference != null && !titleController.confirmingSale && !titleController.confirmingTransaction && !titleController.confirmingGift && mainPanelManager.CurrentPanelAllowsPreviews()) {
