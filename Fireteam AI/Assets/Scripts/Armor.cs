...
public class Armor
{
    ...
    public Armor(string name, int malePrefabPathTop, int malePrefabPathBottom, int femalePrefabPathTop, int femalePrefabPathBottom, string thumbnailPath, string description, float speed, float stamina, float armor, float avoidability, int gpPrice, int kashPrice, bool purchasable, bool deleteable) {
        this.name = name;
