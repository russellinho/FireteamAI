...
public class WeaponHandlerScript : MonoBehaviour
{
    ...
    public void SetWeaponPosition()
    {
        ...
        weapon.localPosition = new Vector3(weapon.localPosition.x - oldHandlePos.x - 0.03f, weapon.localPosition.y - oldHandlePos.y + 0.06f, weapon.localPosition.z - oldHandlePos.z + 0.03f);
    }
