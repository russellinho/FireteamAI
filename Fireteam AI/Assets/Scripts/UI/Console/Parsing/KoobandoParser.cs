...
namespace Koobando.UI.Console
{
    ...
    /// </summary>
    public class KoobandoParser
    {
        private readonly IParser[] _parsers;
        private readonly IGrammarConstruct[] _grammarConstructs;
        ...
        /// </summary>
        /// <param name="parsers">The IParsers to use in this Quantum Parser.</param>
        /// <param name="grammarConstructs">The IGrammarConstructs to use in this Koobando Parser</param>
        public KoobandoParser(IEnumerable<IParser> parsers, IEnumerable<IGrammarConstruct> grammarConstructs)
        {
        ...
        /// <summary>
        /// Creates a Koobando Parser with the default injected parsers.
        /// </summary>
        public KoobandoParser() : this(new InjectionLoader<IParser>().GetInjectedInstances(), new InjectionLoader<IGrammarConstruct>().GetInjectedInstances())
        {
        ...
        private IGrammarConstruct GetMatchingGrammar(string value, Type type)
        {
            foreach (IGrammarConstruct grammar in _grammarConstructs)
            {
                try
                {
        ...
        public object Parse(string value, Type type)
        {
            ...
            IGrammarConstruct grammar = GetMatchingGrammar(value, type);
            if (grammar != null)
            {
                try
                {
