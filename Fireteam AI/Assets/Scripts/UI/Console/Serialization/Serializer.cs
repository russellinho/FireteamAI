...
{
    /// <summary>
    /// Creates a Serializer that is loaded and used by the KoobandoSerializer.
    /// </summary>
    public interface Serializer
    {
        ...
        string SerializeFormatted(object value, Theme theme, Func<object, Theme, string> recursiveSerializer);
    }
}
