...
public class InventoryScript : MonoBehaviour
{
    ...
    void Awake() {
        ...
        // Weapons
        weaponCatalog.Add("AK-47", new Weapon("AK-47", "Primary", "Assault Rifle", 75, "Models/Pics/ak47-thumb", "A classic assault rifle developed in the Soviet Union during the World War II era. It's known for its unmatched stopping power and relatively light weight.", 65f, 90f, 68f, 90f, 70f, 3000f, 30, 120, true, true, true, 100, true, true));
        weaponCatalog.Add("MP5A3", new Weapon("MP5A3", "Primary", "SMG", 79, "Models/Pics/mp5a3-thumb", "The world renowned German engineered masterpiece of submachine guns, the MP5A3 is a worldwide go-to weapon for close quarter combat.", 52f, 98f, 79f, 65f, 55f, 3000f, 30, 120, true, true, true, 100, true, true));
        weaponCatalog.Add("M60", new Weapon("M60", "Primary", "LMG", 77, "Models/Pics/m60-thumb", "An all American classic machine gun manufactured during the Cold War era, this weapon has stood the test of time and is known for it's simple design, portability, and stopping power.", 70f, 75f, 66f, 88f, 67f, 3000f, 100, 300, true, false, false, 100, true, true));
        weaponCatalog.Add("RPG-7", new Weapon("RPG-7", "Secondary", "Launcher", 81, "Models/Pics/rpg7-thumb", "Short for \"rocket-propelled grenade\", the RPG-7 is a portable anti-armor missile launcher that was manufactured in the Soviet Union during the Cold War era. Good for taking out enemy armor and groups.", 110, 80f, -1f, -1f, 64f, 10000f, 1, 4, false, false, false, 100, true, true));
        weaponCatalog.Add("Glock23", new Weapon("Glock23", "Secondary", "Pistol", 82, "Models/Pics/glock23-thumb", "The standard pistol used by United States police officers because of its reliability.", 48f, 100f, 45f, 60f, 56f, 3000f, 12, 60, true, true, false, 100, true, false));
        weaponCatalog.Add("R870", new Weapon("R870", "Primary", "Shotgun", 78, "Models/Pics/r870-thumb", "Short for Remington 870, this shotgun is widely used for home defense due to its quick reload speed and reliability.", 120f, 95f, 17f, -1f, 60f, 1000f, 8, 56, true, false, false, 100, true, true));
        weaponCatalog.Add("L96A1", new Weapon("L96A1", "Primary", "Sniper Rifle", 80, "Models/Pics/l96a1-thumb", "Developed in the 1980s by the British, this bolt-action sniper rifle is known for its deadly stopping power and quick operation speed.", 120f, 40f, 10f, 90f, 65f, 3000f, 5, 20, true, true, false, 100, true, true));
        weaponCatalog.Add("M4A1", new Weapon("M4A1", "Primary", "Assault Rifle", 76, "Models/Pics/m4a1-thumb", "As a successor of the M16A3 assault rifle, this weapon is one of the standard issue rifles in the United States military. It's well known for it's overall reliability and quality.", 57f, 92f, 74f, 80f, 64f, 3000f, 30, 120, true, true, true, 100, true, true));
        weaponCatalog.Add("M67 Frag", new Weapon("M67 Frag", "Support", "Explosive", 87, "Models/Pics/m67frag-thumb", "The standard issue high explosive anti-personnel grenade given to all mercenaries upon completion of basic training.", 135f, 100f, -1f, -1f, -1f, -1f, 1, 3, false, false, false, 100, true, false));
        weaponCatalog.Add("XM84 Flashbang", new Weapon("XM84 Flashbang", "Support", "Explosive", 88, "Models/Pics/xm84flash-thumb", "An explosive non-lethal device used to temporarily blind and disorient your enemies. The closer the enemy is and the more eye exposure given to the device, the longer the effect.", -1f, 100f, -1f, -1f, -1f, -1f, 1, 3, false, false, false, 100, true, true));
        weaponCatalog.Add("Medkit", new Weapon("Medkit", "Support", "Booster", 84, "Models/Pics/medkit-thumb", "Emits a chemical into your body that expedites the coagulation and production of red blood cells. Replenishes 60 HP.", -1f, 100f, -1f, -1f, -1f, -1f, 1, 2, false, false, false, 100, true, true));
        weaponCatalog.Add("Adrenaphine", new Weapon("Adrenaphine", "Support", "Booster", 83, "Models/Pics/adrenalineshot-thumb", "Injects pure adrenaline straight into your blood stream, allowing you to experience unlimited stamina and faster movement speed for 10 seconds.", -1f, 100f, -1f, -1f, -1f, -1f, 1, 2, false, false, false, 100, true, true));
        weaponCatalog.Add("Ammo Bag", new Weapon("Ammo Bag", "Support", "Deployable", 85, "Models/Pics/ammobag-thumb", "A deployable ammo box that allows you and your team to replenish your ammo.", -1f, 90f, -1f, -1f, -1f, -1f, 1, 1, false, false, false, 100, true, true));
        weaponCatalog.Add("First Aid Kit", new Weapon("First Aid Kit", "Support", "Deployable", 86, "Models/Pics/firstaidkit-thumb", "A deployable medical kit that allows you and your team to replish your health.", -1f, 97f, -1f, -1f, -1f, -1f, 1, 1, false, false, false, 100, true, true));
        weaponCatalog.Add("Recon Knife", new Weapon("Recon Knife", "Melee", "Knife", 74, "Models/Pics/reconknife-thumb", "A lightweight, durable, low profile knife that is multipurpose.", 100f, -1f, -1f, -1f, -1f, 7f, 0, 0, false, false, false, 100, false, false));
