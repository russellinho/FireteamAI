...
public class InventoryScript : MonoBehaviour
{
    ...
    void Awake() {
        ...
        Equipment casualShirtMale = new Equipment("Casual Shirt", "Top", "Models/Clothing/Lucas/Tops/Casual Shirt/lucascasualshirt", "Models/Pics/casual_shirt", "A classy yet casual button up.", false, 0f, 0f, 0f);
        Equipment casualTShirtMale = new Equipment("Casual T-Shirt", "Top", "Models/Clothing/Lucas/Tops/V Neck Tee/lucasvnecktee (1)", "Models/Pics/v_neck_shirt", "A casual v neck t-shirt.", false, 0f, 0f, 0f);
        ...
        weaponCatalog.Add("R870", new Weapon("R870", "Primary", "Shotgun","Models/Weapons/Primary/Shotguns/R870", "Models/Pics/r870-thumb", "Short for Remington 870, this shotgun is widely used for home defence due to its quick reload speeds and reliability.", 75f, 65f, 17f, -1f, 60f, 1000f, 7));
