...
public class InventoryScript : MonoBehaviour
{
    ...
    void Awake() {
        ...
        Equipment casualShirtMale = new Equipment("Casual Shirt", "Top", "Models/Clothing/Lucas/Tops/Casual Shirt/lucascasualshirt", "Models/Pics/casual_shirt", "A classy yet casual button up.", false, 1f, 1f, 1f);
        Equipment casualTShirtMale = new Equipment("Casual T-Shirt", "Top", "Models/Clothing/Lucas/Tops/V Neck Tee/lucasvnecktee (1)", "Models/Pics/v_neck_shirt", "A casual v neck t-shirt.", false, 1f, 1f, 1f);
        Equipment standardFatiguesTopMale = new Equipment("Standard Fatigues Top", "Top", "Models/Clothing/Lucas/Tops/Standard Fatigues/lucasstandardfatiguestop", "Models/Pics/standard_fatigue_shirt", "A standard issue shirt given to all solders upon completion of basic training.", false, 1f, 1f, 1f);
        Equipment standardFatiguesTopFemale = new Equipment("Standard Fatigues Top", "Top", "Models/Clothing/Hana/Tops/Standard Fatigues/hanastandardfatiguestop", "Models/Pics/standard_fatigue_shirt_f", "A standard issue shirt given to all solders upon completion of basic training.", false, 1f, 1f, 1f);
        Equipment casualTankTopFemale = new Equipment("Casual Tank Top", "Top", "Models/Clothing/Hana/Tops/Casual Tank Top/hanatanktop", "Models/Pics/casual_tank_top_f", "A casual tank top.", false, 1f, 1f, 1f);
        Equipment casualTShirtFemale = new Equipment("Casual T-Shirt", "Top", "Models/Clothing/Lucas/Tops/V Neck Tee/lucasvnecktee (1)", "Models/Pics/casual_t_shirt_f", "A casual t-shirt.", false, 1f, 1f, 1f);
        Equipment darkWashDenimJeansMale = new Equipment("Dark Wash Denim Jeans", "Bottom", "Models/Clothing/Lucas/Bottoms/Dark Wash Denim Jeans/lucasdarkwashjeans", "Models/Pics/dark_wash_jeans", "Slim fit dark wash jeans.", false, 1f, 1f, 1f);
        Equipment lightWashDenimJeansMale = new Equipment("Light Wash Denim Jeans", "Bottom", "Models/Clothing/Lucas/Bottoms/Light Wash Denim Jeans/lucaslightwashjeans", "Models/Pics/light_wash_jeans", "Slim fit light wash jeans.", false, 1f, 1f, 1f);
        Equipment standardFatiguesBottomMale = new Equipment("Standard Fatigues Bottom", "Bottom", "Models/Clothing/Lucas/Bottoms/Standard Fatigues/lucasstandardfatiguebottom", "Models/Pics/standard_fatigue_pants", "A standard issue pants given to all soldiers upon completion of basic training.", false, 1f, 1f, 1f);
        Equipment darkWashDenimJeansFemale = new Equipment("Dark Wash Denim Jeans", "Bottom", "Models/Clothing/Hana/Bottoms/Dark Wash Denim Jeans/hanadarkwashjeans", "Models/Pics/dark_wash_jeans_f", "Slim fit dark wash jeans.", false, 1f, 1f, 1f);
        Equipment lightWashDenimJeansFemale = new Equipment("Light Wash Denim Jeans", "Bottom", "Models/Clothing/Hana/Bottoms/Dark Wash Denim Jeans/hanalightwashjeans", "Models/Pics/light_wash_jeans_f", "Slim fit light wash jeans.", false, 1f, 1f, 1f);
        Equipment standardFatiguesBottomFemale = new Equipment("Standard Fatigues Bottom", "Bottom", "Models/Clothing/Hana/Bottoms/Standard Fatigues/hanastandardfatiguesbottom", "Models/Pics/standard_fatigue_pants", "A standard issue pants given to all soldiers upon completion of basic training.", false, 1f, 1f, 1f);
        Equipment mich = new Equipment("MICH", "Headgear", "Models/Equipment/Lucas/Head/Standard Combat Helmet/lucasmich", "Models/Pics/mich", "A helmet that can be used for protecting one's head from shrapnel and even bullets.", true, 1f, 1f, 1f);
        Equipment combatBeanie = new Equipment("Combat Beanie", "Headgear", "Models/Equipment/Lucas/Head/Combat Beanie/lucascombatbeanie", "Models/Pics/combat_beanie", "A stylish beanie straight out of your local designer clothing store.", true, 1f, 1f, 1f);
        Equipment comHat = new Equipment("COM Hat", "Headgear", "Models/Equipment/Lucas/Head/COM Hat/lucascomhat", "Models/Pics/com_hat", "A lightweight hat with a mic for optimal communication.", false, 1f, 1f, 1f);
        Equipment saintLaurentMask = new Equipment("Saint Laurent Mask", "Facewear", "Models/Equipment/Lucas/Face/Saint Laurent Mask/lucassaintlaurentmask", "Models/Pics/saint_laurent_mask", "Eliminate your enemies in style with these expensive yet stylish glasses!", false, 1f, 1f, 1f);
        Equipment sportShades = new Equipment("Sport Shades", "Facewear", "Models/Equipment/Lucas/Face/Sport Shades/lucassportshades", "Models/Pics/sport_shades", "Tinted shades with a sporty trim usually used for the shooting range.", false, 1f, 1f, 1f);
        Equipment standardGoggles = new Equipment("Standard Goggles", "Facewear", "Models/Equipment/Lucas/Face/Standard Goggles/lucasgoggles", "Models/Pics/standard_goggles", "Standard issue goggles given to all soldiers upon completion of basic training.", false, 1f, 1f, 1f);
        Equipment surgicalMask = new Equipment("Surgical Mask", "Facewear", "Models/Equipment/Lucas/Face/Surgical Mask/surgicalmask", "Models/Pics/surgical_mask", "A protective, lightweight mask used during medical surgeries.", false, 1f, 1f, 1f);
        Equipment redChucks = new Equipment("Red Chucks", "Footwear", "Models/Clothing/Lucas/Shoes/Chucks/lucasredchucks", "Models/Pics/red_chucks", "These bright canvas shoes are stylish yet lightweight, durable, and comfortable!", false, 1f, 1f, 1f);
        Equipment whiteChucks = new Equipment("White Chucks", "Footwear", "Models/Clothing/Hana/Shoes/White Chucks/hanawhitechucks", "Models/Pics/white_chucks", "The white version of the red chucks; stylish yet lightweight, durable, and comfortable!", false, 1f, 1f, 1f);
        Equipment standardBootsMale = new Equipment("Standard Boots", "Footwear", "Models/Clothing/Lucas/Shoes/Standard Boots/lucasstandardboots", "Models/Pics/standard_boots", "Standard issue combat boots given to all soldiers upon completion of basic training.", false, 1f, 1f, 1f);
        Equipment standardBootsFemale = new Equipment("Standard Boots", "Footwear", "Models/Clothing/Hana/Shoes/Standard Boots/hanastandardboots", "Models/Pics/standard_boots", "Standard issue combat boots given to all soldiers upon completion of basic training.", false, 1f, 1f, 1f);
        Equipment scrubsTopMale = new Equipment("Scrubs Top", "Top", "Models/Clothing/Sayre/Tops/scrubstop", "Models/Pics/scrubs_top", "A comfortable scrubs shirt commonly used in the medical field.", false, 1f, 1f, 1f);
        Equipment scrubsBottomMale = new Equipment("Scrubs Bottom", "Bottom", "Models/Clothing/Sayre/Bottoms/scrubspants", "Models/Pics/scrubs_bottom", "A comfortable scrubs pants commonly used in the medical field.", false, 1f, 1f, 1f);
