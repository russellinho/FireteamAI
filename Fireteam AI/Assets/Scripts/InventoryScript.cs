...
public class InventoryScript : MonoBehaviour
{
    ...
    void Awake() {
        ...
        Equipment casualTShirtMale = new Equipment("Casual T-Shirt (M)", "Top", "Models/Clothing/Lucas/Tops/V Neck Tee/lucasvnecktee (1)", "Models/FirstPersonPrefabs/Tops/Lucas/Casual T-Shirt/male_vneck", "Models/Pics/v_neck_shirt", "A casual v neck t-shirt.", false, 2, 0f, 0f, 0f);
        Equipment standardFatiguesTopMale = new Equipment("Standard Fatigues Top (M)", "Top", "Models/Clothing/Lucas/Tops/Standard Fatigues/lucasstandardfatiguestop", "Models/FirstPersonPrefabs/Tops/Lucas/Standard Fatigues/male_stan_fatigues", "Models/Pics/standard_fatigue_shirt", "A standard issue shirt given to all solders upon completion of basic training.", false, 0, 0f, 0f, 0f);
        Equipment standardFatiguesTopFemale = new Equipment("Standard Fatigues Top (F)", "Top", "Models/Clothing/Hana/Tops/Standard Fatigues/hanastandardfatiguestop", "Models/FirstPersonPrefabs/Tops/Hana/Standard Fatigues/female_stan_fatigues", "Models/Pics/standard_fatigue_shirt_f", "A standard issue shirt given to all solders upon completion of basic training.", false, 0, 0f, 0f, 0f);
        Equipment casualTankTopFemale = new Equipment("Casual Tank Top", "Top", "Models/Clothing/Hana/Tops/Casual Tank Top/hanatanktop", "Models/FirstPersonPrefabs/Tops/Hana/Casual T-Shirt/female_vneck", "Models/Pics/casual_tank_top_f", "A casual tank top.", false, 2, 0f, 0f, 0f);
        Equipment casualTShirtFemale = new Equipment("Casual T-Shirt (F)", "Top", "Models/Clothing/Hana/Tops/Casual T-Shirt/skinhanatshirt", "Models/FirstPersonPrefabs/Tops/Hana/Casual T-Shirt/female_vneck", "Models/Pics/casual_t_shirt_f", "A casual t-shirt.", false, 1, 0f, 0f, 0f);
        Equipment darkWashDenimJeansMale = new Equipment("Dark Wash Denim Jeans (M)", "Bottom", "Models/Clothing/Lucas/Bottoms/Dark Wash Denim Jeans/lucasdarkwashjeans", "", "Models/Pics/dark_wash_jeans", "Slim fit dark wash jeans.", false, 0, 0f, 0f, 0f);
        Equipment lightWashDenimJeansMale = new Equipment("Light Wash Denim Jeans (M)", "Bottom", "Models/Clothing/Lucas/Bottoms/Light Wash Denim Jeans/lucaslightwashjeans", "", "Models/Pics/light_wash_jeans", "Slim fit light wash jeans.", false, 0, 0f, 0f, 0f);
        Equipment standardFatiguesBottomMale = new Equipment("Standard Fatigues Bottom (M)", "Bottom", "Models/Clothing/Lucas/Bottoms/Standard Fatigues/lucasstandardfatiguebottom", "", "Models/Pics/standard_fatigue_pants", "A standard issue pants given to all soldiers upon completion of basic training.", false, 0, 0f, 0f, 0f);
        Equipment darkWashDenimJeansFemale = new Equipment("Dark Wash Denim Jeans (F)", "Bottom", "Models/Clothing/Hana/Bottoms/Dark Wash Denim Jeans/hanadarkwashjeans", "", "Models/Pics/dark_wash_jeans_f", "Slim fit dark wash jeans.", false, 0, 0f, 0f, 0f);
        Equipment lightWashDenimJeansFemale = new Equipment("Light Wash Denim Jeans (F)", "Bottom", "Models/Clothing/Hana/Bottoms/Light Wash Denim Jeans/hanalightwashjeans", "", "Models/Pics/light_wash_jeans_f", "Slim fit light wash jeans.", false, 0, 0f, 0f, 0f);
        Equipment standardFatiguesBottomFemale = new Equipment("Standard Fatigues Bottom (F)", "Bottom", "Models/Clothing/Hana/Bottoms/Standard Fatigues/hanastandardfatiguesbottom", "", "Models/Pics/standard_fatigue_pants", "A standard issue pants given to all soldiers upon completion of basic training.", false, 0, 0f, 0f, 0f);
        ...
        Equipment saintLaurentMaskMale = new Equipment("Aviators", "Facewear", "Models/Equipment/Lucas/Face/Saint Laurent Mask/lucassaintlaurentmask", "", "Models/Pics/saint_laurent_mask", "Eliminate your enemies in style with these expensive yet stylish glasses!", false, 0, 0f, 0.05f, 0f);
        Equipment saintLaurentMaskFemale = new Equipment("Aviators", "Facewear", "Models/Equipment/Hana/Face/Saint Laurent Mask/hanasaintlaurent", "", "Models/Pics/saint_laurent_mask", "Eliminate your enemies in style with these expensive yet stylish glasses!", false, 0, 0f, 0.05f, 0f);
        ...
        Equipment standardBootsMale = new Equipment("Standard Boots (M)", "Footwear", "Models/Clothing/Lucas/Shoes/Standard Boots/lucasstandardboots", "", "Models/Pics/standard_boots", "Standard issue combat boots given to all soldiers upon completion of basic training.", false, 0, 0f, 0f, 0f);
        Equipment standardBootsFemale = new Equipment("Standard Boots (F)", "Footwear", "Models/Clothing/Hana/Shoes/Standard Boots/hanastandardboots", "", "Models/Pics/standard_boots", "Standard issue combat boots given to all soldiers upon completion of basic training.", false, 0, 0f, 0f, 0f);
        Equipment scrubsTopMale = new Equipment("Scrubs Top", "Top", "Models/Clothing/Sayre/Tops/scrubstop", "Models/FirstPersonPrefabs/Tops/Lucas/Casual T-Shirt/male_vneck", "Models/Pics/scrubs_top", "A comfortable scrubs shirt commonly used in the medical field.", false, 2, 0f, 0f, 0f);
        ...
        lucasEquipment.Add("Aviators", saintLaurentMaskMale);
        ...
        darylEquipment.Add("Aviators", saintLaurentMaskMale);
        ...
        sayreEquipment.Add("Aviators", saintLaurentMaskMale);
        ...
        hanaEquipment.Add("Aviators", saintLaurentMaskFemale);
        ...
        jadeEquipment.Add("Aviators", saintLaurentMaskFemale);
